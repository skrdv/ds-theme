        ...
        a.Prototype = function() {
            r.extend(this, s.prototype), this.renderBody = function() {
                if (this.content.appendChild(i(".contributor-name", {
                    ...
                    }))), this.node.orcid && (this.content.appendChild(i(".label", {
                        text: "ORCID"
                    })), this.content.appendChild(i("a.orcid", {
            ...
            this.render = function() {
                ...
                if (e) {
                    ...
                    if (a) {
                        ...
                        e.journal && !t.breadcrumbs && c.push(" in <i>" + e.journal + "</i>"), this.content.appendChild(i(".published-on", {
                            html: c.join("")
                        }))
                    }
                }
    ...
    123: [function(t, e, n) {
        ...
        c.Prototype = function() {
            this._annotationTypes = {
                ...
                for (var n = t.doc, r = e.querySelector("article-meta"), o = r.querySelector("pub-date"), i = r.querySelectorAll("history date"), s = e.querySelector("journal-title"), a = e.querySelector("article-id[pub-id-type=doi]"), c = e.querySelector("related-article"), u = this.extractArticleInfo(t, e), l = {
                        id: "publication_info",
                ...
                var n = {
                    ...
                    r = t.doc,
                    o = [];
                return o = o.concat(this.extractEditor(t, e)), o = o.concat(this.extractDatasets(t, e)), o = o.concat(this.extractCustomMetaGroup(t, e)), o = o.concat(this.extractAcknowledgements(t, e)), o = o.concat(this.extractCopyrightAndLicense(t, e)), o = o.concat(this.extractNotes(t, e)), n.children = o, r.create(n), n
